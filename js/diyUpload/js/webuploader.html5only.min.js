...
!function(a, b) {
    ...
    b("widgets/widget", ["base", "uploader"], function(a, b) {
        ...
        b.register = d.register = function(b, c) {
            ...
            c.responseMap = g) : c.responseMap = e.extend(g, b),
            f = a.inherits(d, c),
            h.push(f),
            f
        }
        ...
        b.inherits(c, {
            ...
            init: function() {
                ...
                b.on("all", function(a) {
                    ...
                    case "change":
                        g = b.exec("getFiles"),
                        b.trigger("select", f.map(g, function(a) {
            ...
            destroy: function() {
                this.runtime && (this.exec("destroy"),
                this.disconnectRuntime())
            }
        }),
        e
        ...
        b.register({
            ...
            start: function() {
                ...
                f.each(b.pool, function(a, c) {
                    var d = c.file;
                    d.getStatus() === h.INTERRUPT && (d.setStatus(h.PROGRESS),
                    b._trigged = !1,
            ...
            stop: function(a) {
                var b = this;
                b.runing !== !1 && (b.runing = !1,
                a && f.each(b.pool, function(a, b) {
                    b.transport && b.transport.abort(),
            ...
            _tick: function() {
                ...
                ,
                d._promise = g(c) ? c.always(b) : b(c)) : d.remaning || d.getStats().numOfQueue || (d.runing = !1,
            ...
            _nextBlock: function() {
                ...
                return d && d.has() && d.file.getStatus() === h.PROGRESS ? (f.prepareNextFile && !c.pending.length && c._prepareNextFile(),
                d.fetch()) : c.runing ? (!c.pending.length && c.getStats().numOfQueue && c._prepareNextFile(),
                a = c.pending.shift(),
                b = function(a) {
                    return a ? (d = e(a, f.chunked ? f.chunkSize : 0),
                    c._act = d,
                    d.fetch()) : null 
                }
                ,
            ...
            _prepareNextFile: function() {
                ...
                c && (a = b.request("before-send-file", c, function() {
                    return c.getStatus() === h.QUEUED ? (b.owner.trigger("uploadStart", c),
            ...
            _doSend: function(b) {
                ...
                l.on("progress", function(a) {
                    var c = 0
                      , d = 0;
                    c = b.percentage = a,
                    b.chunks > 1 && (f.each(k.blocks, function(a, b) {
    ...
    b("runtime/html5/transport", ["base", "runtime/html5/runtime"], function(a, b) {
        ...
        return b.register("Transport", {
            ...
            send: function() {
                ...
                c ? (h.overrideMimeType("application/octet-stream"),
